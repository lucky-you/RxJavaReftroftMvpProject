...
public final class AppUtils {
    ...
    public static void installApp(final File file) {
        ...
        BaseApplication.getInstance().startActivity(getInstallAppIntent(file, true));
    }
    ...
    public static void uninstallApp(final String packageName) {
        ...
        BaseApplication.getInstance().startActivity(getUninstallAppIntent(packageName, true));
    }
    ...
    public static boolean isAppInstalled(@NonNull final String packageName) {
        return !isSpace(packageName)
                && BaseApplication.getInstance().getPackageManager().getLaunchIntentForPackage(packageName) != null;
    }
    ...
    public static void launchApp(final String packageName) {
        if (isSpace(packageName)) return;
        BaseApplication.getInstance().startActivity(getLaunchAppIntent(packageName, true));
    }
    ...
    public static void relaunchApp() {
        ...
        Intent intent = packageManager.getLaunchIntentForPackage(BaseApplication.getInstance().getPackageName());
    ...
    public static void launchAppDetailsSettings() {
        launchAppDetailsSettings(BaseApplication.getInstance().getPackageName());
    }
        ...
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.LOLLIPOP) {
            ...
            try {// Access to usage information.
                ApplicationInfo info =
                        pm.getApplicationInfo(BaseApplication.getInstance().getPackageName(), 0);
                AppOpsManager aom =
                        (AppOpsManager) BaseApplication.getInstance().getSystemService(Context.APP_OPS_SERVICE);
                if (aom != null) {
                ...
                UsageStatsManager usageStatsManager = (UsageStatsManager) BaseApplication.getInstance()
